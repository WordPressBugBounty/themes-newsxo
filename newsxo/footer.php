 ...
 */ ?>
<!-- </main> -->
<?php do_action('newsxo_action_footer_missed_section'); ?>
    <!--==================== FOOTER AREA ====================-->
    ...
    <?php if($footer_bg_img != '') { ?> style="background-image:url('<?php echo get_footer_bg_img()?>');" <?php } ?> >
        <div class="overlay" style="background-color: <?php echo esc_html($newsxo_footer_overlay_color);?>;">
            ...
            $copyright = newsxo_get_option( 'newsxo_footer_copyright'); ?>
                <div class="bs-footer-bottom-area">
                    <div class="container">
                        <div class="row align-center">
                            ...
                            <!--col-lg-3-->
                            <div class="col-lg-6 col-md-6">
                                <?php if(get_theme_mod('footer_social_icon_enable', true) == true) { do_action('newsxo_action_social_section'); } ?>
                            </div>
                            <!--/col-lg-3-->
                        </div>
                        <!--/row-->
                            ...
                            <div class="row">
                                ...
                                <?php if( has_nav_menu( 'footer') ) { ?>
                                    <div class="col-lg-6 col-md-6 text-md-end text-xs">
                                        <?php newsxo_target_element('panel', 'nav_menus', 'Click To Edit Footer Menu.'); ?>
...
<!--/wrapper-->
<!--Scroll To Top-->
    <?php newsxo_scrolltoup(); 
    newsxo_side_menu_section(); 
    newsxo_search_popup(); ?>
<!--/Scroll To Top-->
<?php wp_footer(); ?>
</body>
