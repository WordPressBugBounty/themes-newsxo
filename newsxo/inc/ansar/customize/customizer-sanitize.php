...
if ( ! function_exists( 'newsxo_sanitize_checkbox' ) ) :
     ...
     */
    function newsxo_sanitize_checkbox( $checked ) {
...
if ( ! function_exists( 'newsxo_sanitize_positive_integer' ) ) :
     ...
     */
    function newsxo_sanitize_positive_integer( $input, $setting ) {
...
if ( ! function_exists( 'newsxo_sanitize_number_range' ) ) :
     ...
     */
    function newsxo_sanitize_number_range( $input, $setting ) {
...
if ( ! function_exists( 'newsxo_sanitize_dropdown_pages' ) ) :
     ...
     */
    function newsxo_sanitize_dropdown_pages( $page_id, $setting ) {
...
if ( ! function_exists( 'newsxo_sanitize_image' ) ) :
     ...
     */
    function newsxo_sanitize_image( $image, $setting ) {
...
if ( ! function_exists( 'newsxo_sanitize_radio' ) ) :
function newsxo_sanitize_radio( $val, $setting ) {
...
if ( ! function_exists( 'newsxo_text_sanitization' ) ) :
	 ...
	 */
	if ( ! function_exists( 'newsxo_text_sanitization' ) ) {
		function newsxo_text_sanitization( $input ) {
 ...
 * @return string	Sanitized input
 */
if ( ! function_exists( 'newsxo_sanitize_alpha_color' ) ) :
    function newsxo_sanitize_alpha_color( $value ) {
