...
if ( ! class_exists( 'Newsxo_Customizer_Control' ) ) { 

	class Newsxo_Customizer_Control { 
		...
		public function __construct() {
			...
			add_filter( 'newsxo_customizer_add_settings', array( $this, 'field_add_setting_args' ) );
			add_filter( 'newsxo_customizer_add_control', array( $this, 'field_add_control_args' ) );
		}
		...
		public function customizer_register( $wp_customize ) {
            ...
            foreach ( self::$fields as $field_id => $field_args ) {
				$params = apply_filters( 'newsxo_customizer_add_settings', $field_args, $wp_customize );

				call_user_func( array( $wp_customize, 'add_setting' ), $field_id, $params );

				$args = apply_filters( 'newsxo_customizer_add_control', $field_args, $wp_customize );
				...
				switch ( $field_args['type'] ) {
                    ...
                    break;
					case 'toggle':
						$wp_customize->add_control( new Newsxo_Toggle_Control( $wp_customize, $field_id, $args ) );
                    break;
                    case 'color-alpha':
                        $wp_customize->add_control( new Newsxo_Customize_Alpha_Color_Control( $wp_customize, $field_id, $args ) );
                        break;
					case 'radio-image':
						$wp_customize->add_control( new Newsxo_Custom_Radio_Default_Image_Control( $wp_customize, $field_id, $args ) );
						break;
					case 'layout':
						$wp_customize->add_control( new Newsxo_layout_Customize_Control( $wp_customize, $field_id, $args ) );
						break;
					case 'taxonomies':
						$wp_customize->add_control( new Newsxo_Dropdown_Taxonomies_Control( $wp_customize, $field_id, $args ) );
						break;
					case 'newsxo-sortable':
						$wp_customize->add_control( new Newsxo_Sortable_Control( $wp_customize, $field_id, $args ) );
						break;
					case 'newsxo-range':
						$wp_customize->add_control( new Newsxo_Customizer_Range_Control( $wp_customize, $field_id, $args ) );
						break;
					case 'pro-text':
						$wp_customize->add_control( new Newsxo_Upgrade_Control( $wp_customize, $field_id, $args ) );
						break;
                    default:
	...
	if ( ! function_exists( 'newsxo_customizer' ) ) {

		function newsxo_customizer() {
			return Newsxo_Customizer_Control::get_instance();
		}
	}
	newsxo_customizer();
}