	...
	?>
		...
		<# if ( data.label ) { #>
			...
			<# if ( data.media_query ) { #>
				<ul class="responsive-switchers responsive-switchers-open" data-plm="<# if( data.mobile ){ #> {{{data.mobile.min }}} <# } #>">
					<li class="desktop">
						<button type="button" class="preview-desktop active" data-device="desktop" title="<?php esc_attr_e( 'Desktop', 'newsxo' ); ?>">
							<i class="dashicons dashicons-desktop"></i>
						</button>
					</li>
					<li class="tablet">
						<button type="button" class="preview-tablet" data-device="tablet" title="<?php esc_attr_e( 'Tablet', 'newsxo' ); ?>">
							<i class="dashicons dashicons-tablet"></i>
						</button>
					</li>
					<li class="mobile">
						<button type="button" class="preview-mobile" data-device="mobile" title="<?php esc_attr_e( 'Mobile', 'newsxo' ); ?>">
		...
		<div class="range-slider <# if ( data.media_query ) { #>has-media-queries<# }#>">
			<div class="desktop-range active">
				...
				<span class="range-reset-slider" title="<?php esc_attr_e( 'Reset', 'newsxo' ); ?>"><span class="dashicons dashicons-update"></span></span>
			</div>
			<# if ( data.media_query ) {
