...
function newsxo_slider_layout_manager_customizer( $wp_customize ){

	class Newsxo_layout_Customize_Control extends WP_Customize_Control {	
...
add_action( 'customize_register', 'newsxo_slider_layout_manager_customizer' );