 ...
 * Class Newsxo_Sortable_Control
 */
class Newsxo_Sortable_Control extends WP_Customize_Control
{
	...
	protected function content_template()
	{
        ...
        <ul class="unsortable">
            ...
            <li {{{ data.inputAttrs }}} class='newsxo-sortable-item' data-value='{{ choiceID }}'>
                <span class="newsxo-label">{{{ choiceLabel }}}</span>
                <span class="switch-wrap">
                    <span class="switch"></span>
                </span>
            </li>
            <# }else { #>
            <li {{{ data.inputAttrs }}} class='newsxo-sortable-item invisible' data-value='{{ choiceID }}'>
                <span class="newsxo-label">{{{ choiceLabel }}}</span>
                <span class="switch-wrap">
                    <span class="switch"></span>
                </span>
        ...
        <ul class="sortable">
            ...
            <li {{{ data.inputAttrs }}} class='newsxo-sortable-item' data-value='{{ choiceID }}'>
                <span class="newsxo-choice">
                    <i class='dashicons dashicons-menu'></i>
                    <span class="newsxo-label">
